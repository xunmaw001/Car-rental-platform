						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="chepai" id="chepai" placeholder="车牌" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="paizhaoImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
								<input type="hidden" id="paizhao" name="paizhao" />
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
							...
							<div class="layui-input-block">
								<input type="text" name="haicheriqi" id="haicheriqi" placeholder="还车日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					form.val("myForm", data.data);
																																																																											// 图片赋值
					jquery("#paizhaoImg").attr("src", data.data.paizhao);
																																																																																																								});
