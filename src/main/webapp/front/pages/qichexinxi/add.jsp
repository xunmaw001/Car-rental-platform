		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="qicheleixing" id="qicheleixing" lay-filter="qicheleixing">
						...
						<div class="layui-input-block">
							<input v-model="detail.qicheleibie" type="text" name="qicheleibie" id="qicheleibie" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.youhao" type="text" name="youhao" id="youhao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
						<label class="layui-form-label">租赁价格：</label>
						<div class="layui-input-block">
							<input v-model="detail.zulinjiage" type="text" name="zulinjiage" id="zulinjiage" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">会员折扣：</label>
						<div class="layui-input-block">
							<input v-model="detail.huiyuanzhekou" type="text" name="huiyuanzhekou" id="huiyuanzhekou" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
