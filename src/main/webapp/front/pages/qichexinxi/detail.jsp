				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('qichexinxi','用户租赁')" @click="onAcrossTap('zulindingdan')" type="button" class="layui-btn">
								用户租赁
							</button>
																					<button v-if="isAuth('qichexinxi','会员租赁')" @click="onAcrossTap('huiyuandingdan')" type="button" class="layui-btn">
								会员租赁
							</button>
