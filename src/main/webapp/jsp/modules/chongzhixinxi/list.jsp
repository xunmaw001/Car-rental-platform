...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">充值信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">充值信息列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">充值信息列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												会员号
												<input type="text" id="huiyuanhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
													if($('#huiyuanhaoSearch').val() != null && $('#huiyuanhaoSearch').val() != ''){
					searchForm.huiyuanhao ="%" +  $('#huiyuanhaoSearch').val() + "%";
				}
        ...
        function getDataList() {
			http("chongzhixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
																						huiyuanhao : searchForm.huiyuanhao,	
																																																						},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chongzhixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("chongzhixinxi"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"chongzhixinxi");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"chongzhixinxi");
