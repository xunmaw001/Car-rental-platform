		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑会员订单</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">会员订单管理</li>
								<li class="breadcrumb-item active">编辑会员订单</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">会员订单信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="chepai" name="chepai" class="form-control" placeholder="车牌">
											...
											<div class="form-group col-md-6">
										<label>租赁价格</label>
										<input id="zulinjiage" name="zulinjiage" class="form-control" onchange="calculation()">
									</div>
											<div class="form-group col-md-6">
										<label>会员折扣</label>
										<input id="huiyuanzhekou" name="huiyuanzhekou" class="form-control" onchange="calculation()">
									</div>
											<div class="form-group col-md-6">
										<label>租赁天数</label>
										<input id="zulintianshu" name="zulintianshu" class="form-control" onchange="calculation()">
									</div>
											<div class="form-group col-md-6">
										<label>总价格</label>
										<input id="zongjiage" name="zongjiage" class="form-control" placeholder="总价格">
											...
											<div class="form-group col-md-6">
										<label>租赁日期</label>
										<div id="zulinriqiDate" class="input-append date form_datetime">
											<input id="zulinriqi-input" name="zulinriqi" size="15" type="text" readonly>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "huiyuandingdan/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("huiyuandingdan/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("huiyuandingdan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("huiyuandingdan"+colName,"GET",{
