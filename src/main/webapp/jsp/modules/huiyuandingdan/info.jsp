								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="zulintianshu" name="zulintianshu" class="form-control" v-model="ruleForm.zulintianshu" readonly>
																							</div>
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="zulinriqi" name="zulinriqi" class="form-control" v-model="ruleForm.zulinriqi" readonly>
																							</div>
											
																					<div class="form-group col-md-6">
																								<label>会员号</label>
												
																								<input id="huiyuanhao" name="huiyuanhao" class="form-control" v-model="ruleForm.huiyuanhao" readonly>
																							</div>
