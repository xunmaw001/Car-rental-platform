...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">会员订单管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">会员订单列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">会员订单列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
												...
												<input type="text" id="qichemingchengSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
																																																														...
																																																														<label>
												汽车类型
												<input type="text" id="qicheleixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('dingdanbianhao')">订单编号<i id="dingdanbianhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('zulinriqi')">租赁日期<i id="zulinriqiIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('huiyuanhao')">会员号<i id="huiyuanhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
							...
							var dingdanbianhaoCell  = document.createElement('td');
									...
									row.appendChild(zongjiageCell);
				            				var zulinriqiCell  = document.createElement('td');

												  zulinriqiCell.innerHTML = item.zulinriqi;

				
									row.appendChild(zulinriqiCell);
				            				var huiyuanhaoCell  = document.createElement('td');

												 huiyuanhaoCell.innerHTML = item.huiyuanhao;

				
									row.appendChild(huiyuanhaoCell);
            ...
            crossBtn1.innerHTML = "还车"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"huiyuanhaiche\")");
			if(crossBtnControl('还车') == true){
		...
		function sh(){
			...
			httpJson("huiyuandingdan/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("huiyuandingdan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"huiyuandingdan");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"huiyuandingdan");
