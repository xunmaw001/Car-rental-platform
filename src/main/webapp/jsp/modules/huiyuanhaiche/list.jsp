...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">会员还车管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">会员还车列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">会员还车列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																													...
																													<th>拍照</th>
																																																			...
																																																			<th onclick="sort('haicheriqi')">还车日期<i id="haicheriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var dingdanbianhaoCell  = document.createElement('td');
									...
									row.appendChild(chepaiCell);
				            				var paizhaoCell  = document.createElement('td');

								                  var paizhaoImg = document.createElement('img');
				  paizhaoImg.setAttribute('src',item.paizhao);
				  paizhaoImg.setAttribute('height',100);
				  paizhaoImg.setAttribute('width',100);
				  paizhaoCell.appendChild(paizhaoImg);

				
									row.appendChild(paizhaoCell);
									...
									row.appendChild(beizhuCell);
				            				var haicheriqiCell  = document.createElement('td');

												  haicheriqiCell.innerHTML = item.haicheriqi;

				
									row.appendChild(haicheriqiCell);
		...
		function sh(){
			...
			httpJson("huiyuanhaiche/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("huiyuanhaiche/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"huiyuanhaiche");
