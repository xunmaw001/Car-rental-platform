...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">租赁订单管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">租赁订单管理</li>
								<li class="breadcrumb-item active">租赁订单列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">租赁订单列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"yonghuhaiche\")");
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("zulindingdan/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("zulindingdan/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zulindingdan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"zulindingdan");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"zulindingdan");
